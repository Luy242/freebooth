 ...
 * @author johannes
 */
public class MultiSelectSaveDialog extends javax.swing.JDialog {

    boolean firstTime;
    List<String> images;
    Process proc;
    Preferences onlinePrefs;
    MultiSelectPhotoboothFrame pf;
     ...
     * @param imageName
     */
    public MultiSelectSaveDialog(java.awt.Frame parent, boolean modal, List<String> images, MultiSelectPhotoboothFrame pf) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("MultiSelectSaveDialog.title_1")); // NOI18N
        setAlwaysOnTop(true);
        ...
        jLabel1.setText(bundle.getString("MultiSelectSaveDialog.jLabel1.text_1")); // NOI18N
        ...
        jButton3.setText(bundle.getString("MultiSelectSaveDialog.jButton3.text_1")); // NOI18N
        ...
        jLabel2.setText(bundle.getString("MultiSelectSaveDialog.jLabel2.text_1")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jButton5.setText(bundle.getString("MultiSelectSaveDialog.jButton5.text_1")); // NOI18N
        jButton5.setToolTipText(bundle.getString("MultiSelectSaveDialog.jButton5.toolTipText_1")); // NOI18N
